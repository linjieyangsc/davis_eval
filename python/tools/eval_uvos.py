...
from uvos import Timer,log,cfg,db_eval
from uvos import UVOSLoader,Segmentation
...
def parse_args():
  ...
  # Cast string to Enum
  args.phase = uvos.phase[args.phase.upper()]
...
if __name__ == '__main__':
  ...
  log.info('Loading UVOS phase: {}'.format(args.phase))
  ...
  segmentations = [Segmentation(
    name, osp.join(args.input, name), frames) for name, frames in db.iternames()]
